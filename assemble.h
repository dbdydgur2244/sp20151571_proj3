...
int get_type(char * ); // string이 label인지 address인지 등등 구해주는 함수
...
int opcode_location(Pass1 *, char **, line_inform *line_info); // locationo 계산해주는 함수
